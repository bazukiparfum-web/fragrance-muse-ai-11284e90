  ...
  return (
    <Alert className="mb-6 border-accent">
      ...
      <AlertDescription className="flex items-center justify-between gap-4">
        <div>
          <strong>Cart Migration Required:</strong> You have {oldCartItems.length} item(s) in your old cart. Custom
          scents need to be re-added from your Saved Scents.
        </div>
        <div className="flex gap-2 flex-shrink-0">
          <Button onClick={handleMigrate} size="sm" disabled={migrating}>
